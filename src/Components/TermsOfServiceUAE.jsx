...
const TermsOfServiceUAE = () => {
  const seo = getSeoMeta("https://books.1xl.com/terms-and-conditionsUAE");
  return (
    <>
      {seo && <Seo {...seo} />}
            ...
            color:"black"
              ...
              <div className="policies-content">
                ...
                >
                  ...
                  >
                    the UAE Federal Law No. 2 of 2019 on the Use of Information
                    and Communication Technology (ICT) and Federal Law No. 5 of
                    2012 (UAE Cybercrime Law),
                  </strong>
                  which govern the use of digital media, data privacy, and
                  online services. These laws require the disclosure of the use
                  of cookies and the obtaining of users' consent for their use,
                ...
                <div style={{ color: "black" }} classname="terms-section-1">
                  ...
                  >
                    ...
                    governed by 1XL LLC FZ under the applicable laws of India.
                    These Terms of Service govern your access and usage of the
                    Website, all its pages, and the Services, including:
                  </p>
                  <ul>
                  ...
                  >
                    ...
                    bound by these Terms of Service, as well as any supplemental
                    terms that may apply to specific services. These Terms apply
                    to all users, including, but not limited to, browsers,
                    vendors, customers, clients, and content contributors.
                  </p>
                  <p
                    style={{
                      color: "black",
                  ...
                  <li id="payment-fees">
                    ...
                    <ol>
                      ...
                      >
                        ...
                        payments are to be made in United Arab Emirates Dirham
                        (AED) only.
                      </li>
                      <li
                        style={{ color: "black" }}
...
export default TermsOfServiceUAE;
