              ...
              +91 95 5289 5289
                  ...
                  <div className="policies-content">
                    ...
                    <p className="text-gray  pb-[10px]">
                      {" "}
                      By purchasing products or services from1XL LLC FZ, you
                      agree to ensure payment for any items you may purchase,
                      and you acknowledge that prices are subject to change. We
                      reserve the right to reject or cancel an order for any
                      reason, including errors or omissions in the information
                      you provide. We may request additional information from
                      you prior to confirming a sale and reserve the right to
                      place additional restrictions on the sale of any of our
                    ...
                    <p className="text-gray">
                      ...
                      cases, these fees may include a profit to1XL LLC FZ.
                    </p>
...
export default ShippingPolicyUAE;
