                ...
                <div className="  w-full  bg-white">
                  ...
                  >
                    <li style={{ color: "black" }} className="pt-[10px]">
                      ...
                      1XL LLC FZ (referred to as “Organisation”)
                    </li>
                    <li style={{ color: "black" }} className="pt-[10px]">
                      <strong
                        style={{
                  ...
                  <div className="policies-content">
                    <p className="text-gray">
                      This Policy outlines how 1XL LLC FZ processes and protects
                      your personal data in compliance with the UAE Data
                      Protection Law, the General Data Protection Regulation
                      (GDPR) (when applicable), and other relevant privacy
                      regulations. We prioritise the security and privacy of
                      your information across our platforms and services,
                      including SaaS platforms, online courses, events,
                      podcasts, travel services, and associated websites.
                    </p>
                    <p className="text-gray">
                    ...
                    <h3 className="pt-25" id="Definitions">
                      <strong className="text-black">1. Definitions</strong>
                    </h3>
                    <p className="text-gray">
                    ...
                    <p className="text-gray">
                      <strong className="text-black">1XL Info LLP</strong>
                    ...
                    <p className="text-gray">
                      The website of1XL LLC FZ collects a series of general data
                      and information when a data subject or automated system
                      calls up the website. This general data and information
                      are stored in the server log files. The collected data may
                      include:
                    </p>
                    <ul style={{ listStyleType: "disc", paddingLeft: "18px" }}>
                      <li className="text-black">
                    ...
                    <p className="text-gray">
                      ...
                      1XL website, SaaS platforms, online courses, events,
                    ...
                    <p className="text-gray">
                      ...
                      to personal data processed through our 1XL website, SaaS
                      platforms, online courses, events, podcasts, and travel
                      bookings. For example, if the information related to a
                      SaaS subscription, course enrollment, event participation,
                      or travel booking is found to be inaccurate or incomplete,
                      it can be rectified by providing the correct details.
                    </p>
                    <p className="text-gray">
                    ...
                    <p className="text-gray">
                      ...
                      stored by1XL LLC FZ, he or she may, at any time, contact
                      any employee of the controller. An employee of1XL LLC FZ
                    ...
                    <p className="text-gray">
                      ...
                      data, as far as processing is not required. Employees
                      of1XL LLC FZ will arrange the necessary measures in
                    ...
                    <p className="text-gray">
                      ...
                      employee of1XL LLC FZ will arrange the restriction of the
                      processing, especially in relation to SaaS platforms,
                      event registrations, travel services, or digital product
                      offerings.
                    </p>
                    <h3>
                      <strong className="text-black">
                    ...
                    <p className="text-gray">
                      ...
                      subject may at any time contact any employee of1XL LLC FZ,
                      and the request will be handled promptly, ensuring the
                      seamless transfer of data within SaaS solutions, event
                      management systems, online learning platforms, or travel
                      booking services.
                    </p>
                    <h3>
                      <strong className="text-black">
                    ...
                    <p className="text-gray">
                      ...
                      provisions.1XL LLC FZ shall no longer process the personal
                    ...
                    <p className="text-gray">
                      ...
                      may contact any employee of1XL LLC FZ. In addition, the
                    ...
                    <p className="text-gray">
                      ...
                      subject&rsquo;s explicit consent,1XL LLC FZ shall
                    ...
                    <p className="text-gray">
                      ...
                      applies to consent given for 1XL website, SaaS products,
                      event registrations, online course subscriptions, travel
                      bookings, or marketing communications.
                    </p>
                    <p className="text-gray">
                    ...
                    <p className="text-gray">
                      ...
                      the state of your residence or the authority that
                      oversees1XL LLC FZ.
                    </p>
                    <h3>
                      <strong className="text-black">
                    ...
                    <p className="text-gray">
                      ...
                      applications for positions related to 1XL website, SaaS
                      services, workshops, online course instructors, event
                      staff, or any customer service roles within1XL LLC FZ. The
                      processing may also be carried out electronically. This is
                      the case, in particular, if an applicant submits
                      corresponding application documents by email or through a
                      web form on the website to the controller.
                    </p>
                    <p className="text-gray">
                    ...
                    <ul>
                      <li className="text-black">
                        ...
                        hosted by1XL LLC FZ. If the processing of personal data
                        is necessary for the performance of a contract to which
                        the data subject is a party, such as processing
                    ...
                    <p className="text-gray">
                      ...
                      <strong className="text-black">1XL Info LLP</strong> may
                      be required to disclose your Personal Data if required to
                    ...
                    <ul style={{ listStyleType: "disc", paddingLeft: "18px" }}>
                      ...
                      <li className="text-black">
                        Protect and defend the rights or property of1XL LLC FZ,
                    ...
                    <p className="text-gray">
                      The security of your Personal Data is important to1XL LLC
                      FZ, but remember that no method of transmission over the
                      Internet, or method of electronic storage, is 100% secure.
                      While we strive to use commercially acceptable means to
                      protect your Personal Data across our SaaS platforms,
                      online courses, and event registration systems, we cannot
                      guarantee its absolute security. This includes
                    ...
                    <p className="text-gray">
                      ...
                      needs of all parties involved and fostering growth for1XL
                      LLC FZ and its business operations.
                    </p>
                    <h3>
                      <strong className="text-black">
                        23. Provision of Personal Data: Contractual &amp; Legal
                    ...
                    <p className="text-gray">
                      1XL Info LLP does not perform automatic decision-making or
                      profiling for any of its SaaS platforms, online courses,
