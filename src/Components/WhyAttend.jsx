...
const WhyAttend = () => {
  ...
  return (
    <div>
      <p className="text-lg sm:text-xl md:text-2xl mb-4 md:mb-10 text-purple-50 font-bold max-w-3xl mx-auto">
        Two Young Visionaries:<span className="text-[#FFD700]">A 50-Day Mission to Success</span>
      </p>
      <p className="text-md md:text-lg mb-6 md:mb-10 text-purple-50 font-inter">
