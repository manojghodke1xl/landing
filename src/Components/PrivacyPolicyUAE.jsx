...
const PrivacyPolicyUAE = () => {
  const seo = getSeoMeta("https://books.1xl.com/privacy-policyUAE");
  return (
    <>
      {seo && <Seo {...seo} />}
            ...
            color:"black"
              ...
              <div className="policies-content">
                <p className="text-black">
                  This Privacy Policy explains how 1XL LLC FZ (“Organisation”,
                  “we”, “our”, or “us”) collects, uses, shares, and protects
                  your information across all of our platforms and services,
                  including our SaaS products, online courses, events, podcasts,
                  travel bookings, and websites.
                </p>
  ...
  or biometric data. */}
                ...
                <ul>
                  ...
                  <li className="text-black">
                    3. Affiliates: Within 1XL brands for delivering services
                  </li>
                  <li className="text-black">
